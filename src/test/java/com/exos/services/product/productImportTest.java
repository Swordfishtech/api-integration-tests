...
public class productImportTest extends BaseTest {
    ...
    @Test
    public void db_contains_correct_number_of_products() {
    ...
    @Test
    public void db_contains_group_code() {
    ...
    @Test
    public void empty_correlationId_returns_400_Bad_Request() {
    ...
    @Test
    public void import_clears_db_first() {
        /**
         * insert into the db
